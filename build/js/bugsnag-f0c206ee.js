...
r.exports = function() {
    var e = ["navigation", "request", "process", "log", "user", "state", "error", "manual"]
      ...
      , c = function(e) {
        return "function" == typeof e || a(e) && n(e, (function(e) {
    ...
    f.schema = {
        ...
        enabledErrorTypes: {
            ...
            validate: function(e) {
                ...
                )).length < t.length || n(s(e), (function(t) {
        ...
        endpoints: {
            ...
            validate: function(e) {
                return e && "object" == typeof e && l(e.notify) && l(e.sessions) && 0 === n(s(e), (function(e) {
        ...
        enabledReleaseStages: {
            ...
            validate: function(e) {
                return null === e || a(e) && n(e, (function(e) {
        ...
        enabledBreadcrumbTypes: {
            ...
            validate: function(n) {
                return null === n || a(n) && t(n, (function(t, n) {
                    return !1 === t ? t : r(e, n)
                }
                ), !0)
            }
        ...
        user: {
            ...
            validate: function(e) {
                return null === e || e && t(s(e), (function(e, t) {
        ...
        logger: {
            ...
            validate: function(e) {
                return !e || e && t(["debug", "info", "warn", "error"], (function(t, n) {
        ...
        redactedKeys: {
            ...
            validate: function(e) {
                return a(e) && e.length === n(e, (function(e) {
        ...
        return {
            ...
            parseOpera11: function(n) {
                return n.stack.split("\n").filter((function(e) {
                    ...
                    var n, r = t.split("@"), a = this.extractLocation(r.pop()), o = r.shift() || "", i = o.replace(/<anonymous function(: (\w+))?>/, "$2").replace(/\([^\)]*\)/g, "") || void 0;
    ...
    function V(e) {
        return h(n(e, Boolean), (function(e) {
            ...
            return "string" == typeof n && (r.variant = n),
            r
        }
        ))
    }
    ...
    G.create = function(e, t, n, r, a, o) {
        void 0 === a && (a = 0);
        var i, s = ae(e, t, r, o), u = s[0], c = s[1];
        try {
        ...
        if ("InvalidError" === u.name && i.addMetadata("" + r, "non-error parameter", re(e)),
        u.cause) {
            var f, d = ne(u).slice(1), g = h(d, (function(e) {
                var t = U(e) && K(e) ? O.parse(e) : []
                  , n = ae(e, !0, "error cause")[0];
                return "InvalidError" === n.name && i.addMetadata("error cause", re(e)),
      ...
      , ae = function(e, t, n, r) {
        ...
        if (t)
            ...
            case "function":
                ...
                break;
            case "object":
                null !== e && U(e) ? a = e : null !== e && oe(e) ? ((a = new Error(e.message || e.errorMessage)).name = e.name || e.errorClass,
                o += 1) : (a = i(null === e ? "null" : "unsupported object"),
                o += 2);
                break;
            default:
                a = i("nothing"),
    ...
    var oe = function(e) {
      ...
      , de = 0;
    for (var ge in fe)
        Object.hasOwnProperty.call(fe, ge) && de++;
    ...
    var Oe = Ee
      ...
      , Re = function() {
        ...
        o._configure = function(e, n) {
            var r = t(n, (function(e, t) {
                return t && t.configSchema ? g({}, e, t.configSchema) : e
            }
            ), this._schema)
              , a = t(s(r), (function(t, n) {
                var a = r[n].defaultValue(e[n]);
                return void 0 !== e[n] ? r[n].validate(e[n]) ? r[n].allowPartialObject ? t.config[n] = g(a, e[n]) : t.config[n] = e[n] : (t.errors[n] = r[n].message,
                t.config[n] = a) : t.config[n] = a,
                t
            }
            ), {
                errors: {},
            ...
            return this._metadata = g({}, i.metadata),
        ...
        o.startSession = function() {
            ...
            ce(this._cbs.s, e, "onSession", this._logger) ? (this._logger.debug("Session not started due to onSession callback"),
        ...
        o.leaveBreadcrumb = function(t, n, a) {
            ...
            t) {
                var o = new S(t,n,a);
                ce(this._cbs.b, o, "onBreadcrumb", this._logger) ? this._logger.debug("Breadcrumb not attached due to onBreadcrumb callback") : (this._breadcrumbs.push(o),
        ...
        o._notify = function(e, t, n) {
            ...
            ue(u, e, s, (function(t, r) {
                if (t && s(t),
                !r)
                    return o._logger.debug("Event not sent due to onError callback"),
                    n(null, e);
                o._isBreadcrumbTypeEnabled("error") && a.prototype.leaveBreadcrumb.call(o, e.errors[0].errorClass, {
                    errorClass: e.errors[0].errorClass,
                    errorMessage: e.errors[0].errorMessage,
                    severity: e.severity
                }, "error"),
                i !== e.severity && (e._handledState.severityReason = {
                    type: "userCallbackSetSeverity"
                }),
                e.unhandled !== e._handledState.unhandled && (e._handledState.severityReason.unhandledOverridden = !0,
                e._handledState.unhandled = e.unhandled),
                o._session && (o._session._track(e),
                e._session = o._session),
    ...
    var De = function(e, t, n, r) {
      ...
      , Je = 0;
    for (var We in Xe)
        Object.hasOwnProperty.call(Xe, We) && Je++;
    ...
    var ot = at
      ...
      , st = function() {
        try {
            var e = window.localStorage
              , t = e.getItem(it);
            return t && /^c[a-z0-9]{20,32}$/.test(t) || (t = ot(),
            e.setItem(it, t)),
            t
        } catch (e) {}
    }
      ...
      , dt = {
        startSession: function(e, t) {
            ...
            null === n._config.enabledReleaseStages || r(n._config.enabledReleaseStages, n._config.releaseStage) ? (n._delivery.sendSession({
      ...
      , ht = {
        load: function(e) {
            !/^(local-)?dev(elopment)?$/.test(e._config.releaseStage) && e._isBreadcrumbTypeEnabled("log") && h(pt, (function(n) {
                var r = console[n];
                console[n] = function() {
                    for (var a = arguments.length, o = new Array(a), i = 0; i < a; i++)
                        o[i] = arguments[i];
                    e.leaveBreadcrumb("Console output", t(o, (function(e, t, n) {
                        var r = "[Unknown value]";
                        try {
                            r = String(t)
                        } catch (e) {}
                ...
                if (a._config.trackInlineScripts) {
                    ...
                    var l = null
                      ...
                      , g = function(e) {
                        ...
                        return t(n.slice(a, o), (function(e, t, n) {
                            return e[a + 1 + n] = t.length <= vt ? t : t.substr(0, vt),
                            e
                        }
                        ), {})
                    };
                    a.addOnError((function(e) {
                        ...
                        if (!t || !t.file || t.file.replace(/#.*$/, "") === o.replace(/#.*$/, "")) {
                            ...
                            if (r) {
                                var a = r.innerHTML;
                                e.addMetadata("script", "content", a.length <= mt ? a : a.substr(0, mt)),
                    ...
                    h(["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"], (function(e) {
                        r[e] && r[e].prototype && Object.prototype.hasOwnProperty.call(r[e].prototype, "addEventListener") && (bt(r[e].prototype, "addEventListener", (function(e) {
                            return v(e, _t)
                        }
                        )),
    ...
    var xt = function(e, t) {
      ...
      , Rt = function(e, t) {
        ...
        var n = {
            load: function(n) {
                ...
                function s() {
                    if ("addEventListener"in t.XMLHttpRequest.prototype) {
                        ...
                        t.XMLHttpRequest.prototype.open = function(t, n) {
                            ...
                            a && (this.removeEventListener("load", i),
                ...
                function c(e, t) {
                    void 0 !== t ? "string" == typeof t && r(a, t.replace(/\?.*$/, "")) || n.leaveBreadcrumb("XMLHttpRequest error", {
                        request: e + " " + t
                    }, Lt) : n._logger.warn("The request URL is no longer present on this XMLHttpRequest. A breadcrumb cannot be left for this request.")
                }
                function l() {
                    if ("fetch"in t && !t.fetch.polyfill) {
                        var e = t.fetch;
                        t.fetch = function() {
                            var t, n = arguments, r = arguments[0], a = arguments[1], s = null;
                            return r && "object" == typeof r ? (s = r.url,
                            a && "method"in a ? t = a.method : r && "method"in r && (t = r.method)) : (s = r,
        ...
        load: function(e) {
            ...
            e.addOnError((function(n) {
                if (t >= e._config.maxEvents)
                    return e._logger.warn("Cancelling event send due to maxEvents per session limit of " + e._config.maxEvents + " being reached"),
                    !1;
                t++
            }
            )),
            ...
            load: function(t) {
                ...
                function r(e, r, a, o, i) {
                    if (0 === a && /Script error\.?/.test(e))
                        ...
                        if (i)
                        ...
                        else if ("object" != typeof e || null === e || r && "string" == typeof r || a || o || i)
                            ...
                            (s = t.Event.create({
                                name: c,
                                message: l
                            }, !0, u, "window onerror", 1)).originalError = e,
      ...
      , Ct = function(e, t, n, r) {
        ...
        a.columnNumber || (It(r) ? a.columnNumber = r : window.event && It(window.event.errorCharacter) && (a.columnNumber = window.event.errorCharacter))
    }
      , It = function(e) {
      ...
      , Ut = {
        ...
        createClient: function(e) {
            ...
            return n._setDelivery(window.XDomainRequest ? Ie : Ve),
            n._logger.debug("Loaded!"),
            n.leaveBreadcrumb("Bugsnag loaded", {}, "state"),
            n._config.autoTrackSessions ? n.startSession() : n
        },
        start: function(e) {
            return Ut._client ? (Ut._client._logger.warn("Bugsnag.start() was called more than once. Ignoring."),
            Ut._client) : (Ut._client = Ut.createClient(e),
            Ut._client)
        },
        isStarted: function() {
    ...
    return h(["resetEventCount"].concat(s(Me.prototype)), (function(e) {
        /^_/.test(e) || (Ut[e] = function() {
            if (!Ut._client)
                return console.log("Bugsnag." + e + "() was called before Bugsnag.start()");
            Ut._client._depth += 1;
            var t = Ut._client[e].apply(Ut._client, arguments);
            return Ut._client._depth -= 1,
            t
        }
        )
    }
...
window.Bugsnag.start({
    ...
    metadata: {
        lang: document.documentElement.dataset.wiki
    }
});
var a = e({
    __proto__: null,
